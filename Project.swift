...
let project = Project(
    ...
    settings: .settings(
        configurations: [
            .debug(
                name: "Staging",
                xcconfig: .relativeToRoot("Configs/Staging.xcconfig")
            ),
            .release(
                name: "Production",
                xcconfig: .relativeToRoot("Configs/Production.xcconfig")
            ),
            .debug(
    ...
    schemes: [
        .scheme(
            name: "RadarBursatil Staging",
            shared: true,
            buildAction: .buildAction(
                targets: ["RadarBursatil"]
            ),
            runAction: .runAction(
        ...
        .scheme(
            name: "RadarBursatil Staging-Production",
            shared: true,
            buildAction: .buildAction(
                targets: ["RadarBursatil"]
            ),
